...
public class EReferenceCreation extends EMFChange {

	private final EReference eReference;
	private final long sourceID;
	private final long targetID;
	
	public EReferenceCreation(EReference eReference, long sourceID, long targetID) {
	...
	public void apply(Map<Long, EObject> objects, Map<EObject, Long> ids) {
		...
		EMFUtil.addReferenceValue(source, eReference, target);
	}
