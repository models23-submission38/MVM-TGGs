...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Enum Constant Declaration adapted anonymous Class Declaration Item</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.mdelab.migmm.history.modisco.java.adapted.java_adapted.impl.EnumConstantDeclaration_adapted_anonymousClassDeclarationItemImpl#getAnonymousClassDeclaration <em>Anonymous Class Declaration</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumConstantDeclaration_adapted_anonymousClassDeclarationItemImpl extends ContainmentEdgeWithHistoryImpl implements EnumConstantDeclaration_adapted_anonymousClassDeclarationItem {
	/**
	 ...
	 * @generated
	 */
	protected EnumConstantDeclaration_adapted_anonymousClassDeclarationItemImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Java_adaptedPackage.eINSTANCE.getEnumConstantDeclaration_adapted_anonymousClassDeclarationItem();
	}
		...
		if (anonymousClassDeclaration != null && anonymousClassDeclaration.eIsProxy()) {
			...
			if (anonymousClassDeclaration != oldAnonymousClassDeclaration) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Java_adaptedPackage.ENUM_CONSTANT_DECLARATION_ADAPTED_ANONYMOUS_CLASS_DECLARATION_ITEM__ANONYMOUS_CLASS_DECLARATION, oldAnonymousClassDeclaration, anonymousClassDeclaration));
			}
		}
	...
	public void setAnonymousClassDeclaration(AnonymousClassDeclaration_adapted newAnonymousClassDeclaration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Java_adaptedPackage.ENUM_CONSTANT_DECLARATION_ADAPTED_ANONYMOUS_CLASS_DECLARATION_ITEM__ANONYMOUS_CLASS_DECLARATION, oldAnonymousClassDeclaration, anonymousClassDeclaration));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Java_adaptedPackage.ENUM_CONSTANT_DECLARATION_ADAPTED_ANONYMOUS_CLASS_DECLARATION_ITEM__ANONYMOUS_CLASS_DECLARATION:
...
} //EnumConstantDeclaration_adapted_anonymousClassDeclarationItemImpl
