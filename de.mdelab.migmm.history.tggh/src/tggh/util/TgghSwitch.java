 ...
 * @generated
 */
public class TgghSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TgghPackage.HISTORY2_HISTORY: {
				History2History history2History = (History2History)theEObject;
				T result = caseHistory2History(history2History);
				if (result == null) result = caseTGGNodeWithHistory(history2History);
				if (result == null) result = caseTGGNode(history2History);
				if (result == null) result = caseElementWithHistory(history2History);
				if (result == null) result = caseMLAnnotatedElement(history2History);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TgghPackage.TGG_NODE_WITH_HISTORY: {
				TGGNodeWithHistory tggNodeWithHistory = (TGGNodeWithHistory)theEObject;
				T result = caseTGGNodeWithHistory(tggNodeWithHistory);
				if (result == null) result = caseTGGNode(tggNodeWithHistory);
				if (result == null) result = caseElementWithHistory(tggNodeWithHistory);
				if (result == null) result = caseMLAnnotatedElement(tggNodeWithHistory);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
