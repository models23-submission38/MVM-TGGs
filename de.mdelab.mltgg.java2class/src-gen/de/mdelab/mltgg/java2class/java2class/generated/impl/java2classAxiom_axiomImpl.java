...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>java2class Axiom axiom</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.mdelab.mltgg.java2class.java2class.generated.impl.java2classAxiom_axiomImpl#getAddElementActivity <em>Add Element Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.java2class.java2class.generated.impl.java2classAxiom_axiomImpl#getMoveElementActivity <em>Move Element Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.java2class.java2class.generated.impl.java2classAxiom_axiomImpl#getChangeAttributeActivity <em>Change Attribute Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.java2class.java2class.generated.impl.java2classAxiom_axiomImpl#getTransformForwardActivity <em>Transform Forward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.java2class.java2class.generated.impl.java2classAxiom_axiomImpl#getTransformMappingActivity <em>Transform Mapping Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.java2class.java2class.generated.impl.java2classAxiom_axiomImpl#getTransformBackwardActivity <em>Transform Backward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.java2class.java2class.generated.impl.java2classAxiom_axiomImpl#getSynchronizeForwardActivity <em>Synchronize Forward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.java2class.java2class.generated.impl.java2classAxiom_axiomImpl#getSynchronizeBackwardActivity <em>Synchronize Backward Activity</em>}</li>
 * </ul>
 *
 * @generated
 */
public class java2classAxiom_axiomImpl extends OperationalAxiomImpl implements java2classAxiom_axiom {
	/**
	 ...
	 * @generated
	 */
	protected java2classAxiom_axiomImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return GeneratedPackage.Literals.JAVA2CLASS_AXIOM_AXIOM;
	}
			...
			if (addElementActivity != oldAddElementActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.JAVA2CLASS_AXIOM_AXIOM__ADD_ELEMENT_ACTIVITY, oldAddElementActivity,
							addElementActivity));
			}
		}
	...
	public Activity getMoveElementActivity() {
		if (moveElementActivity != null && moveElementActivity.eIsProxy()) {
			...
			if (moveElementActivity != oldMoveElementActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.JAVA2CLASS_AXIOM_AXIOM__MOVE_ELEMENT_ACTIVITY, oldMoveElementActivity,
							moveElementActivity));
			}
		}
	...
	public Activity getChangeAttributeActivity() {
		if (changeAttributeActivity != null && changeAttributeActivity.eIsProxy()) {
			...
			if (changeAttributeActivity != oldChangeAttributeActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.JAVA2CLASS_AXIOM_AXIOM__CHANGE_ATTRIBUTE_ACTIVITY,
	...
	public void setChangeAttributeActivity(Activity newChangeAttributeActivity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					GeneratedPackage.JAVA2CLASS_AXIOM_AXIOM__CHANGE_ATTRIBUTE_ACTIVITY, oldChangeAttributeActivity,
	...
	public Activity getTransformForwardActivity() {
		if (transformForwardActivity != null && transformForwardActivity.eIsProxy()) {
			...
			if (transformForwardActivity != oldTransformForwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.JAVA2CLASS_AXIOM_AXIOM__TRANSFORM_FORWARD_ACTIVITY,
	...
	public void setTransformForwardActivity(Activity newTransformForwardActivity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					GeneratedPackage.JAVA2CLASS_AXIOM_AXIOM__TRANSFORM_FORWARD_ACTIVITY, oldTransformForwardActivity,
	...
	public Activity getTransformMappingActivity() {
		if (transformMappingActivity != null && transformMappingActivity.eIsProxy()) {
			...
			if (transformMappingActivity != oldTransformMappingActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.JAVA2CLASS_AXIOM_AXIOM__TRANSFORM_MAPPING_ACTIVITY,
	...
	public void setTransformMappingActivity(Activity newTransformMappingActivity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					GeneratedPackage.JAVA2CLASS_AXIOM_AXIOM__TRANSFORM_MAPPING_ACTIVITY, oldTransformMappingActivity,
	...
	public Activity getTransformBackwardActivity() {
		if (transformBackwardActivity != null && transformBackwardActivity.eIsProxy()) {
			...
			if (transformBackwardActivity != oldTransformBackwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.JAVA2CLASS_AXIOM_AXIOM__TRANSFORM_BACKWARD_ACTIVITY,
	...
	public void setTransformBackwardActivity(Activity newTransformBackwardActivity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					GeneratedPackage.JAVA2CLASS_AXIOM_AXIOM__TRANSFORM_BACKWARD_ACTIVITY, oldTransformBackwardActivity,
	...
	public Activity getSynchronizeForwardActivity() {
		if (synchronizeForwardActivity != null && synchronizeForwardActivity.eIsProxy()) {
			...
			if (synchronizeForwardActivity != oldSynchronizeForwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.JAVA2CLASS_AXIOM_AXIOM__SYNCHRONIZE_FORWARD_ACTIVITY,
	...
	public Activity getSynchronizeBackwardActivity() {
		if (synchronizeBackwardActivity != null && synchronizeBackwardActivity.eIsProxy()) {
			...
			if (synchronizeBackwardActivity != oldSynchronizeBackwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.JAVA2CLASS_AXIOM_AXIOM__SYNCHRONIZE_BACKWARD_ACTIVITY,
	...
	public TGGNode addElement(final EMap<String, Object> parameters, final EList<EObject> leftInputElements,
		...
		((de.mdelab.mltgg.java2class.java2class.generated.java2classOperationalTGG) this.getOperationalAxiomGroup()
		...
		if (tggNode != null) {
			...
			rightInputElements.add((org.eclipse.emf.ecore.EObject) parametersCopy.get("uMLClassDiagram"));
		}
	...
	public ErrorCodeEnum transformForward(final EList<EObject> leftInputElements,
		...
		if (errorCode == ErrorCodeEnum.OK) {
			rightInputElements.add((org.eclipse.emf.ecore.EObject) parameters.get("uMLClassDiagram"));
		}
	...
	public ErrorCodeEnum transformMapping(final EList<EObject> leftInputElements,
		...
		parameters.put("__checkAttributeFormulae", checkAttributeFormulae);
		parameters.put("model", leftInputElements.get(0));
		parameters.put("uMLClassDiagram", rightInputElements.get(0));
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case GeneratedPackage.JAVA2CLASS_AXIOM_AXIOM__ADD_ELEMENT_ACTIVITY:
			if (resolve)
				return getAddElementActivity();
			return basicGetAddElementActivity();
		case GeneratedPackage.JAVA2CLASS_AXIOM_AXIOM__MOVE_ELEMENT_ACTIVITY:
			if (resolve)
				return getMoveElementActivity();
			return basicGetMoveElementActivity();
		case GeneratedPackage.JAVA2CLASS_AXIOM_AXIOM__CHANGE_ATTRIBUTE_ACTIVITY:
			if (resolve)
				return getChangeAttributeActivity();
			return basicGetChangeAttributeActivity();
		case GeneratedPackage.JAVA2CLASS_AXIOM_AXIOM__TRANSFORM_FORWARD_ACTIVITY:
			if (resolve)
				return getTransformForwardActivity();
			return basicGetTransformForwardActivity();
		case GeneratedPackage.JAVA2CLASS_AXIOM_AXIOM__TRANSFORM_MAPPING_ACTIVITY:
			if (resolve)
				return getTransformMappingActivity();
			return basicGetTransformMappingActivity();
		case GeneratedPackage.JAVA2CLASS_AXIOM_AXIOM__TRANSFORM_BACKWARD_ACTIVITY:
			if (resolve)
				return getTransformBackwardActivity();
			return basicGetTransformBackwardActivity();
		case GeneratedPackage.JAVA2CLASS_AXIOM_AXIOM__SYNCHRONIZE_FORWARD_ACTIVITY:
			if (resolve)
				return getSynchronizeForwardActivity();
			return basicGetSynchronizeForwardActivity();
		case GeneratedPackage.JAVA2CLASS_AXIOM_AXIOM__SYNCHRONIZE_BACKWARD_ACTIVITY:
			if (resolve)
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case GeneratedPackage.JAVA2CLASS_AXIOM_AXIOM___ADD_ELEMENT__EMAP_ELIST_ELIST:
			return addElement((EMap<String, Object>) arguments.get(0), (EList<EObject>) arguments.get(1),
					(EList<EObject>) arguments.get(2));
		case GeneratedPackage.JAVA2CLASS_AXIOM_AXIOM___CHANGE_ATTRIBUTE_VALUES__TGGNODE_EMAP:
			return changeAttributeValues((TGGNode) arguments.get(0), (EMap<String, Object>) arguments.get(1));
		case GeneratedPackage.JAVA2CLASS_AXIOM_AXIOM___TRANSFORM_FORWARD__ELIST_ELIST_BOOLEAN:
			return transformForward((EList<EObject>) arguments.get(0), (EList<EObject>) arguments.get(1),
					(Boolean) arguments.get(2));
		case GeneratedPackage.JAVA2CLASS_AXIOM_AXIOM___TRANSFORM_MAPPING__ELIST_ELIST_BOOLEAN:
			return transformMapping((EList<EObject>) arguments.get(0), (EList<EObject>) arguments.get(1),
					(Boolean) arguments.get(2));
		case GeneratedPackage.JAVA2CLASS_AXIOM_AXIOM___TRANSFORM_BACKWARD__ELIST_ELIST_BOOLEAN:
			return transformBackward((EList<EObject>) arguments.get(0), (EList<EObject>) arguments.get(1),
					(Boolean) arguments.get(2));
		case GeneratedPackage.JAVA2CLASS_AXIOM_AXIOM___SYNCHRONIZE_FORWARD__ELIST_ELIST_TGGNODE_BOOLEAN:
		...
		case GeneratedPackage.JAVA2CLASS_AXIOM_AXIOM___SYNCHRONIZE_BACKWARD__ELIST_ELIST_TGGNODE_BOOLEAN:
