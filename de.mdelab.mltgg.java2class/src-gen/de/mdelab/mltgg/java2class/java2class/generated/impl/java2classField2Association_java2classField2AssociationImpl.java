...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>java2class Field2 Association java2class Field2 Association</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.mdelab.mltgg.java2class.java2class.generated.impl.java2classField2Association_java2classField2AssociationImpl#getAddElementActivity <em>Add Element Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.java2class.java2class.generated.impl.java2classField2Association_java2classField2AssociationImpl#getMoveElementActivity <em>Move Element Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.java2class.java2class.generated.impl.java2classField2Association_java2classField2AssociationImpl#getChangeAttributeActivity <em>Change Attribute Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.java2class.java2class.generated.impl.java2classField2Association_java2classField2AssociationImpl#getTransformForwardActivity <em>Transform Forward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.java2class.java2class.generated.impl.java2classField2Association_java2classField2AssociationImpl#getTransformMappingActivity <em>Transform Mapping Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.java2class.java2class.generated.impl.java2classField2Association_java2classField2AssociationImpl#getTransformBackwardActivity <em>Transform Backward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.java2class.java2class.generated.impl.java2classField2Association_java2classField2AssociationImpl#getConflictCheckForwardActivity <em>Conflict Check Forward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.java2class.java2class.generated.impl.java2classField2Association_java2classField2AssociationImpl#getConflictCheckMappingActivity <em>Conflict Check Mapping Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.java2class.java2class.generated.impl.java2classField2Association_java2classField2AssociationImpl#getConflictCheckBackwardActivity <em>Conflict Check Backward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.java2class.java2class.generated.impl.java2classField2Association_java2classField2AssociationImpl#getSynchronizeForwardActivity <em>Synchronize Forward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.java2class.java2class.generated.impl.java2classField2Association_java2classField2AssociationImpl#getSynchronizeBackwardActivity <em>Synchronize Backward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.java2class.java2class.generated.impl.java2classField2Association_java2classField2AssociationImpl#getRepairForwardActivity <em>Repair Forward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.java2class.java2class.generated.impl.java2classField2Association_java2classField2AssociationImpl#getRepairBackwardActivity <em>Repair Backward Activity</em>}</li>
 * </ul>
 *
 * @generated
 */
public class java2classField2Association_java2classField2AssociationImpl extends OperationalRuleImpl
		implements java2classField2Association_java2classField2Association {
	/**
	 ...
	 * @generated
	 */
	protected java2classField2Association_java2classField2AssociationImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return GeneratedPackage.Literals.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION;
	}
			...
			if (addElementActivity != oldAddElementActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION__ADD_ELEMENT_ACTIVITY,
	...
	public Activity getMoveElementActivity() {
		if (moveElementActivity != null && moveElementActivity.eIsProxy()) {
			...
			if (moveElementActivity != oldMoveElementActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION__MOVE_ELEMENT_ACTIVITY,
	...
	public Activity getChangeAttributeActivity() {
		if (changeAttributeActivity != null && changeAttributeActivity.eIsProxy()) {
			...
			if (changeAttributeActivity != oldChangeAttributeActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION__CHANGE_ATTRIBUTE_ACTIVITY,
	...
	public Activity getTransformForwardActivity() {
		if (transformForwardActivity != null && transformForwardActivity.eIsProxy()) {
			...
			if (transformForwardActivity != oldTransformForwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION__TRANSFORM_FORWARD_ACTIVITY,
	...
	public Activity getTransformMappingActivity() {
		if (transformMappingActivity != null && transformMappingActivity.eIsProxy()) {
			...
			if (transformMappingActivity != oldTransformMappingActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION__TRANSFORM_MAPPING_ACTIVITY,
	...
	public Activity getTransformBackwardActivity() {
		if (transformBackwardActivity != null && transformBackwardActivity.eIsProxy()) {
			...
			if (transformBackwardActivity != oldTransformBackwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION__TRANSFORM_BACKWARD_ACTIVITY,
	...
	public Activity getConflictCheckForwardActivity() {
		if (conflictCheckForwardActivity != null && conflictCheckForwardActivity.eIsProxy()) {
			...
			if (conflictCheckForwardActivity != oldConflictCheckForwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION__CONFLICT_CHECK_FORWARD_ACTIVITY,
	...
	public Activity getConflictCheckMappingActivity() {
		if (conflictCheckMappingActivity != null && conflictCheckMappingActivity.eIsProxy()) {
			...
			if (conflictCheckMappingActivity != oldConflictCheckMappingActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION__CONFLICT_CHECK_MAPPING_ACTIVITY,
	...
	public Activity getConflictCheckBackwardActivity() {
		if (conflictCheckBackwardActivity != null && conflictCheckBackwardActivity.eIsProxy()) {
			...
			if (conflictCheckBackwardActivity != oldConflictCheckBackwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION__CONFLICT_CHECK_BACKWARD_ACTIVITY,
	...
	public Activity getSynchronizeForwardActivity() {
		if (synchronizeForwardActivity != null && synchronizeForwardActivity.eIsProxy()) {
			...
			if (synchronizeForwardActivity != oldSynchronizeForwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION__SYNCHRONIZE_FORWARD_ACTIVITY,
	...
	public Activity getSynchronizeBackwardActivity() {
		if (synchronizeBackwardActivity != null && synchronizeBackwardActivity.eIsProxy()) {
			...
			if (synchronizeBackwardActivity != oldSynchronizeBackwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION__SYNCHRONIZE_BACKWARD_ACTIVITY,
	...
	public Activity getRepairForwardActivity() {
		if (repairForwardActivity != null && repairForwardActivity.eIsProxy()) {
			...
			if (repairForwardActivity != oldRepairForwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION__REPAIR_FORWARD_ACTIVITY,
	...
	public Activity getRepairBackwardActivity() {
		if (repairBackwardActivity != null && repairBackwardActivity.eIsProxy()) {
			...
			if (repairBackwardActivity != oldRepairBackwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION__REPAIR_BACKWARD_ACTIVITY,
	...
	public TGGNode addElement(final EMap<String, Object> parameters) throws TransformationException {
		...
		return (TGGNode) parametersCopy.get("corrAssociation");
	}
	...
	public boolean changeAttributeValues(final TGGNode correspondenceNode, final EMap<String, Object> ruleParameters)
		...
		params.put("corrAssociation", correspondenceNode);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION__ADD_ELEMENT_ACTIVITY:
			if (resolve)
				return getAddElementActivity();
			return basicGetAddElementActivity();
		case GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION__MOVE_ELEMENT_ACTIVITY:
			if (resolve)
				return getMoveElementActivity();
			return basicGetMoveElementActivity();
		case GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION__CHANGE_ATTRIBUTE_ACTIVITY:
			if (resolve)
				return getChangeAttributeActivity();
			return basicGetChangeAttributeActivity();
		case GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION__TRANSFORM_FORWARD_ACTIVITY:
			if (resolve)
				return getTransformForwardActivity();
			return basicGetTransformForwardActivity();
		case GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION__TRANSFORM_MAPPING_ACTIVITY:
			if (resolve)
				return getTransformMappingActivity();
			return basicGetTransformMappingActivity();
		case GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION__TRANSFORM_BACKWARD_ACTIVITY:
			if (resolve)
				return getTransformBackwardActivity();
			return basicGetTransformBackwardActivity();
		case GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION__CONFLICT_CHECK_FORWARD_ACTIVITY:
			if (resolve)
				return getConflictCheckForwardActivity();
			return basicGetConflictCheckForwardActivity();
		case GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION__CONFLICT_CHECK_MAPPING_ACTIVITY:
			if (resolve)
				return getConflictCheckMappingActivity();
			return basicGetConflictCheckMappingActivity();
		case GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION__CONFLICT_CHECK_BACKWARD_ACTIVITY:
			if (resolve)
				return getConflictCheckBackwardActivity();
			return basicGetConflictCheckBackwardActivity();
		case GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION__SYNCHRONIZE_FORWARD_ACTIVITY:
			if (resolve)
				return getSynchronizeForwardActivity();
			return basicGetSynchronizeForwardActivity();
		case GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION__SYNCHRONIZE_BACKWARD_ACTIVITY:
			if (resolve)
				return getSynchronizeBackwardActivity();
			return basicGetSynchronizeBackwardActivity();
		case GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION__REPAIR_FORWARD_ACTIVITY:
			if (resolve)
				return getRepairForwardActivity();
			return basicGetRepairForwardActivity();
		case GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION__REPAIR_BACKWARD_ACTIVITY:
			if (resolve)
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION___ADD_ELEMENT__EMAP:
			return addElement((EMap<String, Object>) arguments.get(0));
		case GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION___CHANGE_ATTRIBUTE_VALUES__TGGNODE_EMAP:
			return changeAttributeValues((TGGNode) arguments.get(0), (EMap<String, Object>) arguments.get(1));
		case GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION___MOVE_ELEMENT__TGGNODE_TGGNODE_TGGNODE:
			return moveElement((TGGNode) arguments.get(0), (TGGNode) arguments.get(1), (TGGNode) arguments.get(2));
		case GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION___TRANSFORM_FORWARD__TGGNODE_BOOLEAN_BOOLEAN:
			return transformForward((TGGNode) arguments.get(0), (Boolean) arguments.get(1), (Boolean) arguments.get(2));
		case GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION___TRANSFORM_MAPPING__TGGNODE_BOOLEAN_BOOLEAN:
			return transformMapping((TGGNode) arguments.get(0), (Boolean) arguments.get(1), (Boolean) arguments.get(2));
		case GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION___TRANSFORM_BACKWARD__TGGNODE_BOOLEAN_BOOLEAN:
			return transformBackward((TGGNode) arguments.get(0), (Boolean) arguments.get(1),
					(Boolean) arguments.get(2));
		case GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION___CONFLICT_CHECK_FORWARD__TGGNODE:
			return conflictCheckForward((TGGNode) arguments.get(0));
		case GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION___CONFLICT_CHECK_MAPPING__TGGNODE:
			return conflictCheckMapping((TGGNode) arguments.get(0));
		case GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION___CONFLICT_CHECK_BACKWARD__TGGNODE:
			return conflictCheckBackward((TGGNode) arguments.get(0));
		case GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION___SYNCHRONIZE_FORWARD__TGGNODE_BOOLEAN:
			return synchronizeForward((TGGNode) arguments.get(0), (Boolean) arguments.get(1));
		case GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION___SYNCHRONIZE_BACKWARD__TGGNODE_BOOLEAN:
			return synchronizeBackward((TGGNode) arguments.get(0), (Boolean) arguments.get(1));
		case GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION___REPAIR_FORWARD__TGGNODE_BOOLEAN:
			return repairForward((TGGNode) arguments.get(0), (Boolean) arguments.get(1));
		case GeneratedPackage.JAVA2CLASS_FIELD2_ASSOCIATION_JAVA2CLASS_FIELD2_ASSOCIATION___REPAIR_BACKWARD__TGGNODE_BOOLEAN:
			return repairBackward((TGGNode) arguments.get(0), (Boolean) arguments.get(1));
		}
		return super.eInvoke(operationID, arguments);
	}

} //java2classField2Association_java2classField2AssociationImpl
